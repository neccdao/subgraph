...
export function runTests(): void {
  test("LP entity is removed after BuyNDOL and SellNDOL event is emitted due to zero ndol and token amount. Account and Action entities created too", () => {
